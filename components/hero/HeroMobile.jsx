...
export default function HeroMobile() {
    return (
        <section className="relative lg:hidden h-[100dvh] bg-white overflow-hidden">

            {/* soft glow */}
            <div className="absolute top-28 left-1/2 -translate-x-1/2 w-[280px] h-[280px] bg-blue-400/20 blur-[120px] rounded-full"></div>
